...
vim.api.nvim_set_hl(0, "CursorLineNr", { fg = c.white, bold = false })
...
vim.api.nvim_set_hl(0, "@keyword.coroutine", { fg = c.red })
vim.api.nvim_set_hl(0, "@keyword.exception", { fg = c.red })
...
vim.api.nvim_set_hl(0, "@type", { fg = c.nord7 })
...
vim.api.nvim_set_hl(0, "@string.special", { fg = c.grey })
