...
vim.api.nvim_set_hl(0, "IlluminatedWordText", { bg = "#2E3542" })
vim.api.nvim_set_hl(0, "IlluminatedWordRead", { bg = "#2E3542" })
vim.api.nvim_set_hl(0, "IlluminatedWordWrite", { bg = "#2E3542" })
...
vim.api.nvim_set_hl(0, "@keyword.operator", { fg = c.purple })
...
-- Primitives
vim.api.nvim_set_hl(0, "@boolean", { fg = c.nord8 })
